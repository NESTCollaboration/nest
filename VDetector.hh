...
public:
	...
	virtual double FitS1 ( double xPos_mm, double yPos_mm, double zPos_mm ) { return DefaultFitS1(xPos_mm, yPos_mm, zPos_mm); }
	virtual double FitEF ( double xPos_mm, double yPos_mm, double zPos_mm ) { return DefaultFitEF(xPos_mm, yPos_mm, zPos_mm); }
	virtual double FitS2 ( double xPos_mm, double yPos_mm ) { return DefaultFitS2(xPos_mm, yPos_mm); }
...
private:
	...
	double DefaultFitS1 ( double xPos_mm, double yPos_mm, double zPos_mm );

	//Drift electric field as function of Z in mm
	//For example, use a high-order poly spline
	double DefaultFitEF ( double xPos_mm, double yPos_mm, double zPos_mm );

	//S2 PDE custom fit for function of r
	//s2polA + s2polB*r[mm] + s2polC*r^2+... (QE included, for binom dist) e.g.
	double DefaultFitS2 ( double xPos_mm, double yPos_mm );
