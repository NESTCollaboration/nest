//DENSITY 3.0 g^3/cm
//Enriched to 80.6%
//expected energy resolution sigma_E/E = 1.6%
//Feducial mass of 140 kg
//Q Value of Xenon 136 is 2457.8
//178 nm scintillation light
//Inner cyllindrical diameter: 39.62 cm
//inner cyllindar height: 44.5 cm
//Feducial height 10mm < z < 182mm (convert to usec)
...
public:
  ...
  virtual void Initialization() {
    ...
    g1_gas = 0.97; //CHANGED (MAYBE)
    s2Fano = 0.059; //CHANGED (liquid xenon value)
    s2_thr = 165.;//(150.*1.173)/0.915; //65-194 pe in 1608.05381
    E_gas = 3.7; //CHANGED (This is supposed to be the value of the E field at the border, but since there is no border I just used a provided E field value)
    eLife_us = 800.; //p.44 of James Verbus PhD thesis Brown
    
    // Thermodynamic Properties
    inGas = false; //duh
    T_Kelvin = 167.; //1910.04211 CHANGED
    p_bar = 1.47; //1910.04211 CHANGED
  ...
  virtual double FitEF ( double xPos_mm, double yPos_mm, double zPos_mm ) { // in V/cm
    ...
    return 3.7; //CHANGED https://arxiv.org/pdf/1202.2192.pdf section 3.2.2 (might change later)
