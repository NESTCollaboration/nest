...
#ifndef DetectorExample_LUX_RUN02_hh
#define DetectorExample_LUX_RUN02_hh 1
...
class DetectorExample_LUX_RUN02: public VDetector {
  
public:
  
  DetectorExample_LUX_RUN02() {
  ...
  ~DetectorExample_LUX_RUN02() override = default;;
  
  // Do here the initialization of all the parameters that are not varying as a function of time
  void Initialization() override {
    
    // Primary Scintillation (S1) parameters
    g1 = 0.15; //0.117+/-0.003 WS,0.115+/-0.005 D-D,0.115+/-0.005 CH3T,0.119+/-0.001 LUXSim
